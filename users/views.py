...
from learn.models import Listing, LikedListing
from .forms import ProfileForm, UserForm, LocationForm
...
def login_view(request):
    if request.method == 'POST':
        ...
        if login_form.is_valid():
            ...
            messages.success(request, f'An error occured while trying to login')
...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            messages.error(request, f'An error occured while trying to register.')
            return render(request, 'views/register.html', {'register_form': register_form,})
